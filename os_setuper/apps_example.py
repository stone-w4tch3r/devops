                ...
                ConfigModification(
                    ...
                    lambda cfg: cfg.modify_chained(
                        [
                            ...
                            lambda c: c["extensionEnabledApiProposals"]["GitHub.copilot-chat"].set(
                                ["handleIssueUri", "interactive", "terminalDataWriteEvent", "terminalExecuteCommandEvent", "terminalSelection",
                                 "terminalQuickFixProvider", "chatParticipant", "chatParticipantAdditions", "defaultChatParticipant",
                                 "chatVariableResolver",
                                 "chatProvider", "mappedEditsProvider", "aiRelatedInformation", "codeActionAI", "findTextInFiles",
                                 "textSearchProvider",
                                 "contribSourceControlInputBoxMenu", "newSymbolNamesProvider", "findFiles2"]
                            ),
                            lambda c: c["extensionVirtualWorkspacesSupport"]["trustedExtensionAuthAccess"].set(
                                ["vscode.git", "vscode.github", "github.remotehub", "github.vscode-pull-request-github", "github.codespaces",
                                 "github.copilot", "github.copilot-chat"]
                            ),
                            lambda c: c["extensionVirtualWorkspacesSupport"]["trustedExtensionProtocolHandlers"].set(
                                ["vscode.git", "vscode.github-authentication"]
                            )
                        ]
                    )
                )
