...
class TestBackup(unittest.TestCase):
    backup_item = ImportedItem(Path(TARGET_PATH).expanduser().resolve(), Path(BACKUP_PATH).expanduser().resolve(), None)
...
# 
#         # assert
#         self.assertEqual(result, RestoreResult._PyExecutionError)
# 
